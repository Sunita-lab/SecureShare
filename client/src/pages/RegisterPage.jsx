    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-emerald-100 flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">Your secure file vault awaits</p>
        </div>
        ...
        <div className="glass rounded-3xl p-8 shadow-2xl">
          ...
          <p className="text-center text-gray-600">
            ...
            <Link to="/login" className="font-semibold bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent hover:opacity-80">
              Sign in →
            </Link>
          </p>
        </div>
